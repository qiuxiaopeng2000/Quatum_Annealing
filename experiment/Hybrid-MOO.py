...
for name in names_FSP:
    ...
    # solve with NSGA-II
    result1 = GASolver.solve(iterations=1, populationSize=100, maxEvaluations=200000, crossoverProbability=0.8,
...
for name in names_NRP:
    ...
    # solve with NSGA-II
    result1 = GASolver.solve(iterations=1, populationSize=100, maxEvaluations=100000, crossoverProbability=0.8,
                             mutationProbability=(1 / problem.variables_num), seed=1, problem=problem)
    ga_result = MethodResult('ga', problem_result.path, lp)
    ga_result.add(result1)
