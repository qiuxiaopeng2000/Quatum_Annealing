...
for name in names_NRP:
    ...
    # hymoo_result.load()
    # Single-objective
    sa_result = MethodResult('sa_', sa_problem_result.path, problem)
    ...
    scores_sa = hysoo_problem_result.statistical_analysis(method1="hysoo", method2="sa_", weights=weight_NRP)
    table_sa = Visualizer.tabulate_single_problem(
        name, ['hysoo', 'sa_'], ['time', 'statistic', 'p_value', 'mean', 'std', 'max', 'min'],
